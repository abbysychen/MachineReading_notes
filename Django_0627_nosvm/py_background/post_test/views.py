...
def java(request):
    ...
    if form.is_valid():  # 如果提交的数据合法
        ...
        ssss={'year_return':str(year_return),'month_return':str(month_return),'competitor':competitor_re,'classifier':classifier_model_s,'tp':tp,'sentence':sentence_s,'sentence_post':sentence_post_s}
        print(ssss)
